...
<tbody>
<tr>
<td style="font-family:Helvetica Neue,Helvetica,Arial,sans-serif;height:4px;font-size:4px;line-height:4px"></td>
</tr>
<tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="m_-475921313878443882wrapper" style="width:100%;border-collapse:separate;border-spacing:0;margin:0 auto">
<tbody>
<tr>
...
<h1 style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#333333;font-size:18px;font-weight:400;line-height:1.4;margin:0;padding:0" align="center">Hello, {{$user->user_name}}!</h1>
<p>You recently requested to reset your password for Royal account</p>
<p>If you didn't perform this request , you can safely ignore this email</p>
<p>Otherwise ,  use this code to complete the process </p>
<div><strong class="card-text">
	 {{$link}}
