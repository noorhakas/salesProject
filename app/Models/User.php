...
//	protected function getDefaultGuardName(): string { return 'web'; }
     ...
     */
    protected $fillable = ['emp_no','name','email','password','user_name','whatsapp','phone','status','position','access_all_data','DeviceToken','DeviceType','active_code','manager_id','is_admin'];
