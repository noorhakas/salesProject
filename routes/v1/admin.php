...
Route::group(['middleware' => ['auth:sanctum']], function(){
   ...
   ###users
	...
	Route::get('managers/{manager}', 'UserProfileController@managerProfile');
    Route::get('managers/{manager}/supervisors', 'UserProfileController@managerSupervisors');
   ...
   // Route::get('managers/{manager}/reps/statistics', 'UserProfileController@managerRepsStatistics');
    ...
    Route::get('branch_report/{branchId}/sales-rep','BranchReportController@salesReps');
...
/*========================export&&import==================================*/
       ...
       //    Route::post('useraccount','AccountController@importUserAccounts');
		    ...
		    Route::post('useraccount','UserController@importUserList');
		    Route::post('user_list','UserController@importUserList');
            Route::post('salesrep','UserController@importSalesRep');
